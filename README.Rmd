...
1. In the **Git** tab of the RStudio IDE panel, select the **modules-exercise1** branch to load the files associated with this particular exercise / demonstration
